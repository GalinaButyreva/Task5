...
// можно было ограничиться настройкой в application.properties (работает без кода в GlobalExceptionHandler)
@ControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    // можно было ограничиться настройкой в application.properties
